...
/**
 * Servlet implementation class UpdateFullName
 */
@WebServlet("/UpdateFullName")
public class UpdateFullName extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fullnameNew = (String) params.get("fullnameNew");
		...
		newDocument.append("$set", new BasicDBObject().append("fullname", fullnameNew));
